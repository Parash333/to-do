...
/**
 * This CategoryAdapter creates and binds ViewHolders, that hold the name of a category,
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder> {
    ...
    /**
     * Constructor for the CatgoryAdapter that initializes the Context.
     *
     ...
     *
     * @return A new CategoryViewHolder that holds the view for each category
     */
    @Override
    ...
    /**
     * When data changes, this method updates the list of catEntries
    ...
    class CategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        /**
         * Constructor for the CategoryViewHolders.
         *
